...
class EncoderDecoderAttributionModel(AttributionModel):
    ...
    def prepare_inputs_for_attribution(
        ...
        r"""
        Prepares sources and target to produce an :class:`~am_inseq.data.EncoderDecoderBatch`.
        ...
        Returns:
            :obj:`EncoderDecoderBatch`: An :class:`~am_inseq.data.EncoderDecoderBatch` object containing sources
    ...
    def enrich_step_output(
        ...
        :class:`~am_inseq.data.FeatureAttributionStepOutput` object.

        Args:
            step_output (:class:`~aminseq.data.FeatureAttributionStepOutput`): The output produced
                by the attribution step, with missing batch information.
            batch (:class:`~aminseq.data.EncoderDecoderBatch`): The batch on which attribution was performed.
        ...
        Returns:
            :class:`~aminseq.data.FeatureAttributionStepOutput`: The enriched attribution output.
        """
