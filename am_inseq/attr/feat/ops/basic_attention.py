...
class AttentionWeights(BaseAttentionAttribution):
    ...
    Refer to :meth:`~am_inseq.attr.feat.ops.BaseAttentionAttribution._aggregate_layers` and
    :meth:`~am_inseq.attr.feat.ops.BaseAttentionAttribution._aggregate_attention_heads` for more details on the
