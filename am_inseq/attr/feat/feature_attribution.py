...
class FeatureAttribution(Registry):
    ...
    def __init__(self, attribution_model: "AttributionModel", hook_to_model: bool = True, **kwargs):
        ...
        to the model calling the :meth:`~am_inseq.attr.feat.FeatureAttribution.hook` method of the child class.

        Args:
            attribution_model (:class:`~aminseq.models.AttributionModel`): The attribution model
    ...
    def load(
        ...
        **kwargs,
        ...
        Args:
            ...
            attribution_model (:class:`~am_inseq.models.AttributionModel`, `optional`): An instance of an
                :class:`~am_inseq.models.AttributionModel` child class. If not provided, the method
        ...
        Returns:
            :class:`~aminseq.attr.feat.FeatureAttribution`: The loaded attribution method.
        """
    ...
    def prepare_and_attribute(
        ...
        Wraps the attribution method :meth:`~am_inseq.attr.feat.FeatureAttribution.attribute` method
        and the :meth:`~am_inseq.models.AttributionModel.prepare_inputs_for_attribution` method.

        Args:
            sources (:obj:`FeatureAttributionInput`): The sources provided to the
                :meth:`~am_inseq.attr.feat.FeatureAttribution.prepare` method.
            ...
            step_scores (:obj:`list` of `str`): List of identifiers for step scores that need to be computed during
                attribution. The available step scores are defined in :obj:`am_inseq.attr.feat.STEP_SCORES_MAP` and new
                step scores can be added by using the :meth:`~am_inseq.register_step_function` function.
        ...
        Returns:
            :class:`~aminseq.data.FeatureAttributionOutput`: An object containing a list of sequence attributions, with
                an optional added list of single :class:`~am_inseq.data.FeatureAttributionStepOutput` for each step and
    ...
    def attribute(
        ...
        Args:
            batch (:class:`~aminseq.data.EncoderDecoderBatch` or :class:`~aminseq.data.DecoderOnlyBatch`): The batch of
    ...
    def filtered_attribute_step(
        ...
        Args:
            ...
            step_scores_args (:obj:`dict`, `optional`): Additional arguments to pass to the step scores functions.
        Returns:
            :class:`~aminseq.data.FeatureAttributionStepOutput`: A dataclass containing attribution tensors for source
    ...
    def format_attribute_args(
        ...
        **kwargs,
        ...
        Args:
            batch (:class:`~aminseq.data.DecoderOnlyBatch` or :class:`~aminseq.data.EncoderDecoderBatch`): The batch of
            ...
            **kwargs: Additional arguments to pass to the model-specific
                :meth:`am_inseq.models.AttributionModel.format_attribution_args` method.
        Returns:
    ...
    def attribute_step(
        ...
        Returns:
            :class:`~aminseq.data.FeatureAttributionStepOutput`: A dataclass containing a tensor of source
...
def list_feature_attribution_methods():
    ...
    `integrated_gradients`) can be passed to :class:`~am_inseq.models.AttributionModel` or :meth:`~am_inseq.load_model`
