...
def list_step_functions() -> List[str]:
    ...
    :meth:`~am_inseq.models.AttributionModel.attribute` method either to compute scores while attributing (``step_scores``
...
def register_step_function(
    ...
    :class:`~am_inseq.data.attribution.FeatureAttributionOutput` object. Registered step functions can also be used as
    ...
    Args:
        ...
        unused ones when defining your function):
            ...
            - :obj:`attribution_model`: an :class:`~am_inseq.models.AttributionModel` instance, corresponding to the model
            ...
            - :obj:`encoder_input_ids`, :obj:`decoder_input_ids`, :obj:`encoder_input_embeds`,
                ...
                elements composing the :class:`~am_inseq.data.Batch` used as context of the model.
        ...
        aggregate_map (:obj:`dict`, `optional`): An optional dictionary mapping from :class:`~am_inseq.data.Aggregator`
