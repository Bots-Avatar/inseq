...
class BatchEncoding(TensorWrapper):
    """Output produced by the tokenization process using :meth:`~am_inseq.models.AttributionModel.encode`.
...
class BatchEmbedding(TensorWrapper):
    """Embeddings produced by the embedding process using :meth:`~am_inseq.models.AttributionModel.embed`.
...
class Batch(TensorWrapper):
    ...
    Attributes:
        encoding (:class:`~aminseq.data.BatchEncoding`): Output produced by the tokenization process using
            :meth:`~am_inseq.models.AttributionModel.encode`.
        embedding (:class:`~aminseq.data.BatchEmbedding`): Embeddings produced by the embedding process using
            :meth:`~am_inseq.models.AttributionModel.embed`.
...
class EncoderDecoderBatch(TensorWrapper):
    ...
    Attributes:
        sources (:class:`~aminseq.data.Batch`): Batch of input data for the source text.
        targets (:class:`~aminseq.data.Batch`): Batch of input data for the target prefix.
    """
