...
class SequenceAttributionAggregator(Aggregator):
    ...
    Args:
        attr (:class:`~aminseq.data.FeatureAttributionSequenceOutput`): The attribution object to aggregate.
...
class PairAggregator(SequenceAttributionAggregator):
    ...
    Args:
        attr (:class:`~aminseq.data.FeatureAttributionSequenceOutput`): The starting attribution object.
        paired_attr (:class:`~aminseq.data.FeatureAttributionSequenceOutput`): The attribution object with whom
