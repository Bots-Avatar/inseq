...
class HuggingfaceModel(AttributionModel):
    ...
    def __init__(
        ...
        detokenizer: Union[str, PreTrainedTokenizer, None] = None,
        **kwargs,
    ) -> None:
        """
        ...
        if detokenizer is not None:
            detokenizer_name = detokenizer if isinstance(detokenizer, str) else self.model_name
            self.detokenizer = GPT2Tokenizer.from_pretrained(detokenizer_name)
